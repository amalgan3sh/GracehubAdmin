...
<html lang="en" dir="ltr">
    <head>
        ...
        <meta charset="utf-8" />
                <title>GraceHub - Admin & Dashboard</title>
    ...
    <div class="position-reletive h-100" data-simplebar style="overflow-x: hidden;">
        <ul class="nav nav-tabs" role="tablist" id="tab-menu">
            ...
            <!-- New Church icon -->
            <li class="nav-item" data-bs-toggle="tooltip" data-bs-placement="right" title="Church" data-bs-trigger="hover">
                <a href="#MetricaChurch" id="church-tab" class="nav-link">
                    <i class="fas fa-church menu-icon"></i> <!-- Replace with appropriate church icon -->
                </a><!--end nav-link-->
            </li><!--end nav-item-->
                ...
                <div class="menu-body navbar-vertical tab-content" data-simplebar>
                    <div id="MetricaDashboard" class="main-icon-menu-pane tab-pane" role="tabpanel"
                        ...
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="crypto-index.html">Church Management</a>
                            </li><!--end nav-item-->
                            <li class="nav-item">
                                <a class="nav-link" href="crm-index.html">Member Activity</a>
                            </li><!--end nav-item-->
                            <li class="nav-item">
                                <a class="nav-link" href="projects-index.html">Financial</a>
                            </li><!--end nav-item-->
                            <li class="nav-item">
                                <a class="nav-link" href="ecommerce-index.html">Event Management</a>
                            </li><!--end nav-item-->
                            <li class="nav-item">
                                <a class="nav-link" href="helpdesk-index.html">Content Management</a>
                            </li><!--end nav-item-->
                            <li class="nav-item">
                                <a class="nav-link" href="hospital-index.html">Community Engagement</a>
                            </li><!--end nav-item-->
                        </ul><!--end nav-->
                    </div><!-- end Dashboards -->
                    ...
                    <div id="MetricaChurch" class="main-icon-menu-pane tab-pane" role="tabpanel" aria-labelledby="church-tab">
    <div class="title-box">
        <h6 class="menu-title">Church Management</h6>
    </div>
    <ul class="nav flex-column">
        <li class="nav-item">
            <a class="nav-link" href="manage-churches.html">Manage Churches</a>
        </li><!--end nav-item-->
        <li class="nav-item">
            <a class="nav-link" href="manage-vicars.html">Manage Vicars</a>
        </li><!--end nav-item-->
        <li class="nav-item">
            <a class="nav-link" href="manage-parish-members.html">Parish Members</a>
        </li><!--end nav-item-->
        <li class="nav-item">
            <a class="nav-link" href="manage-announcements.html">Announcements</a>
        </li><!--end nav-item-->
        <li class="nav-item">
            <a class="nav-link" href="manage-gallery.html">Gallery</a>
        </li><!--end nav-item-->
        <li class="nav-item">
            <a class="nav-link" href="manage-events.html">Events</a>
        </li><!--end nav-item-->
        <li class="nav-item">
            <a class="nav-link" href="manage-community.html">Community Engagement</a>
        </li><!--end nav-item-->
        <li class="nav-item">
            <a class="nav-link" href="manage-finances.html">Finances</a>
        </li><!--end nav-item-->
        <li class="nav-item">
            <a class="nav-link" href="manage-bible-readings.html">Bible Readings</a>
        </li><!--end nav-item-->
    </ul><!--end nav-->
</div><!-- end Church Management -->
